    ...
    const mockPosts = [
        {
            ...
            slug: "future-of-ai-saas",
            image_url: "https://images.unsplash.com/photo-1677442136019-21780ecad995",
            created_at: new Date().toISOString(),
            excerpt: "How generative AI is reshaping the way we build and scale modern software-as-a-service platforms."
        },
        {
            title: "Next.js 15: What's New for Agencies",
            slug: "nextjs-15-agencies",
            image_url: "https://images.unsplash.com/photo-1618477247222-acbdb0e159b3",
            created_at: new Date().toISOString(),
            excerpt: "A deep dive into the latest features of Next.js and how they accelerate agency workflows."
        }
    ];

    const displayedPosts = posts && posts.length > 0 ? posts : mockPosts;
                    ...
                    {displayedPosts.map((post: any, index) => (
                        ...
                        >
                            <div className="aspect-video rounded-[2.5rem] overflow-hidden relative glass border border-white/5">
                                <img
                                    src={post.image_url || "https://images.unsplash.com/photo-1498050108023-c5249f4df085"}
                                    alt={post.title}
