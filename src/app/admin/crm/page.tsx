  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 border-b border-white/10 pb-6">
        <div>
          <div className="flex items-center gap-3">
            <h1 className="text-3xl font-extrabold text-white tracking-tight">CRM & Pipeline</h1>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-5 gap-3.5">
        <div className="bg-slate-900/60 border border-white/10 p-4 rounded-2xl">
          <div className="flex items-center justify-between">
            <span className="text-xs font-semibold text-slate-400">Total Leads</span>
            <Users className="w-4 h-4 text-blue-400" />
          </div>
          <p className="text-2xl font-black text-white mt-2">{totalLeads}</p>
          <p className="text-[11px] text-slate-500 mt-1">In active CRM database</p>
        </div>

        <div className="bg-slate-900/60 border border-yellow-500/20 p-4 rounded-2xl relative overflow-hidden">
          <div className="flex items-center justify-between">
            <span className="text-xs font-semibold text-yellow-400">Contacted / Outreach</span>
            <Send className="w-4 h-4 text-yellow-400" />
          </div>
          <p className="text-2xl font-black text-white mt-2">{contactedCount}</p>
          <p className="text-[11px] text-slate-500 mt-1">SMTP & QStash dispatched</p>
        </div>

        <div className="bg-slate-900/60 border border-purple-500/20 p-4 rounded-2xl">
          <div className="flex items-center justify-between">
            <span className="text-xs font-semibold text-purple-400">Proposal Sent</span>
            <Briefcase className="w-4 h-4 text-purple-400" />
          </div>
          <p className="text-2xl font-black text-white mt-2">{proposalCount}</p>
          <p className="text-[11px] text-slate-500 mt-1">Negotiating scope & SOW</p>
        </div>

        <div className="bg-slate-900/60 border border-green-500/20 p-4 rounded-2xl">
          <div className="flex items-center justify-between">
            <span className="text-xs font-semibold text-green-400">Converted Clients</span>
            <CheckCircle2 className="w-4 h-4 text-green-400" />
          </div>
          <p className="text-2xl font-black text-white mt-2">{convertedCount}</p>
          <p className="text-[11px] text-slate-500 mt-1">Active client projects</p>
        </div>

        <div className="bg-slate-900/60 border border-emerald-500/20 p-4 rounded-2xl col-span-2 sm:col-span-2 lg:col-span-1">
          <div className="flex items-center justify-between">
            <span className="text-xs font-semibold text-emerald-400">New Inbound Replies</span>
            <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse" />
          </div>
          <p className="text-2xl font-black text-emerald-300 mt-2">{newRepliesCount}</p>
          <p className="text-[11px] text-slate-500 mt-1">Awaiting admin action</p>
        </div>
      </div>

      {/* ─── Search, Filter & View Mode Controls ───────────────────────── */}
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 bg-white/[0.02] border border-white/10 p-3 rounded-2xl">
        {/* Search */}
        <div className="relative flex-1 min-w-[240px]">
          ...
          <input
            ...
            className="w-full bg-white/5 border border-white/10 rounded-xl pl-10 pr-4 py-2 text-sm text-white placeholder-slate-500 focus:outline-none focus:border-blue-500 transition"
          />
        </div>
        ...
        <div className="flex items-center gap-2">
          <select
            ...
            className="bg-white/5 border border-white/10 text-slate-300 rounded-xl px-3 py-2 text-xs font-semibold focus:outline-none focus:border-blue-500 transition cursor-pointer"
          >
